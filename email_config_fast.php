<?php
// Fast Email Configuration for Forgot Password
// Optimized settings for faster email delivery

function loadFastEmailConfig() {
    ...
    // Define constants with optimized settings
    ...
    define('MAX_RESET_ATTEMPTS_PER_HOUR', $_ENV['MAX_RESET_ATTEMPTS_PER_HOUR'] ?? 5); // Increased limit
    
    // Fast delivery settings
    define('SMTP_TIMEOUT', 5);           // Faster timeout
    define('SMTP_KEEPALIVE', true);      // Keep connections alive
    define('EMAIL_PRIORITY', 1);         // High priority
}
